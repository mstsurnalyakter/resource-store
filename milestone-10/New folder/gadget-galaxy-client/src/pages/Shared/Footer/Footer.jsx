...
const Footer = () => {
  return (
    ...
    bg-gradient-to-r from-[#0A0A9C] via-purple-600 to-[#AB06D3] bg-300% text-transparent animate-gradient
     text-[#e8ded4] py-4"
    >
        ...
        <div className="lg:w-1/3">
          <div className="flex justify-center space-x-3 lg:justify-start">
            <div className="self-center flex items-center text-lg md:text-2xl font-semibold">
              <img
                className="w-20"
                src="https://i.ibb.co/gVBH3pm/logo.png"
                alt=""
              />
              <h3>GadgetGalaxy</h3>
            </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span>gadgetGalaxy@gmail.com</span>
                </a>
              </li>
              <li>
                <a
